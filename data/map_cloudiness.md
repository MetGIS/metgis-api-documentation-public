# Cloudiness Map (tcdcprs)

This map shows the forecast amount of cloudiness (% of sky coverage).
...
### Cloudiness Map World

Tiles can be fetched with following urls: 

```
https://t1.metgis.com/tcdcprs-world_{t}/{z}/{x}/{y}.png?key=<my-key>
https://t2.metgis.com/tcdcprs-world_{t}/{z}/{x}/{y}.png?key=<my-key>
https://t3.metgis.com/tcdcprs-world_{t}/{z}/{x}/{y}.png?key=<my-key>
```
...
```
https://t1.metgis.com/tcdcprs_{t}/{z}/{x}/{y}.png?key=<my-key>
https://t2.metgis.com/tcdcprs_{t}/{z}/{x}/{y}.png?key=<my-key>
https://t3.metgis.com/tcdcprs_{t}/{z}/{x}/{y}.png?key=<my-key>
```
        ...
        style: {
          ...
          sources: {
            ...
            cloudiness: {
              ...
              tiles: [
                'https://t1.metgis.com/tcdcprs_7/{z}/{x}/{y}.png?key=<my-key>',
                'https://t2.metgis.com/tcdcprs_7/{z}/{x}/{y}.png?key=<my-key>',
                'https://t3.metgis.com/tcdcprs_7/{z}/{x}/{y}.png?key=<my-key>'
              ],
              tileSize: 256
            }
          },
